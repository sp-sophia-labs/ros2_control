...
public:
  ...
  controller_interface::ControllerInterfaceSharedPtr load_controller(
    const std::string & controller_name, const std::string & controller_manager_namespace, const std::string & controller_type);
  ...
  CONTROLLER_MANAGER_PUBLIC
  controller_interface::ControllerInterfaceSharedPtr load_controller(
    const std::string & controller_name, const std::string & controller_manager_namespace);
